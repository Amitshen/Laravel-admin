...
class MailTemplateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.mails-template.index')->with('msg', $msg);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dashboard.partners.index')->with('msg', 'Mail Template Deleted Successfully');
    }
}
