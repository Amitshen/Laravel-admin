<header id="rs-header" class="rs-header">
    ...
    <div class="topbar-area">
        <div class="container">
            <div class="row rs-vertical-middle">
                <div class="col-lg-2">
                    <div class="logo-part">
                        <a href="index-2.html"><img src="{{url('frontend/assets/images/logo-dark.png')}}" alt=""></a>
                    </div>
                </div>
    ...
    <div class="menu-area menu-sticky">
        <div class="container">
            <div class="logo-area">
                <a href="index-2.html">
                    <img class="sticky-logo" src="{{url('frontend/assets/images/logo-dark.png')}}" alt="logo">
                </a>
            </div>
                ...
                <div class="main-menu">
                    <div class="mobile-menu">
                        <a href="index-2.html" class="mobile-logo">
                            <img src="{{url('frontend/assets/images/logo-light.png')}}" alt="logo">
                        </a>
                                        ...
                                        <div class="mega-menu-innner">
                                            ...
                                            <div class="single-megamenu">
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="last-item"><a href="index14.html">Technology Agency</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="single-megamenu">
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="last-item"><a href="onepage7.html">IT Solution 02</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="single-megamenu">
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="last-item"><a href="onepage14.html">Technology Agency</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
