            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 footer-widget">
                    ...
                    <div class="textwidget pb-30">
                        <p>Sedut perspiciatis unde omnis iste natus error sitlutem acc usantium doloremque denounce with
...
<!-- modernizr js -->
<script src="{{url('frontend/assets/js/modernizr-2.8.3.min.js')}}"></script>
<!-- jquery latest version -->
<script src="{{url('frontend/assets/js/jquery.min.js')}}"></script>
<!-- Bootstrap v4.4.1 js -->
<script src="{{url('frontend/assets/js/bootstrap.min.js')}}"></script>
<!-- Menu js -->
<script src="{{url('frontend/assets/js/rsmenu-main.js')}}"></script>
<!-- op nav js -->
<script src="{{url('frontend/assets/js/jquery.nav.js')}}"></script>
<!-- owl.carousel js -->
<script src="{{url('frontend/assets/js/owl.carousel.min.js')}}"></script>
<!-- wow js -->
<script src="{{url('frontend/assets/js/wow.min.js')}}"></script>
<!-- Skill bar js -->
<script src="{{url('frontend/assets/js/skill.bars.jquery.js')}}"></script>
...
<!-- particles js -->
<script src="{{url('frontend/assets/js/particles.min.js')}}"></script>
<!-- magnific popup js -->
<script src="{{url('frontend/assets/js/jquery.magnific-popup.min.js')}}"></script>
<!-- plugins js -->
<script src="{{url('frontend/assets/js/plugins.js')}}"></script>
<!-- pointer js -->
<script src="{{url('frontend/assets/js/pointer.js')}}"></script>
<!-- contact form js -->
<script src="{{url('frontend/assets/js/contact.form.js')}}"></script>
<!-- appointment form js -->
<script src="{{url('frontend/assets/js/appointment.form.js')}}"></script>
<!-- main js -->
