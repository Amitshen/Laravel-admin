...
@endphp
    <!-- ======================= Home Banner ======================== -->
    <div class="home-banner margin-bottom-0" style="background:#f41b3b url(assets/img/banner-2.jpg) no-repeat;" data-overlay="5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    ...
                    <form class="main-search-wrap fl-wrap half-column" method="GET" action="{{route('search-products')}}">
                        <div class="main-search-item" style="width: 100%;">
                            <span class="search-tag">Find</span>
                            <input type="text" class="form-control radius" name="search" placeholder="Search by product name..." />
                        </div>
                        <div class="main-search-button">
                            <button class="btn full-width theme-bg text-white" type="submit">Search<i class="fas fa-search"></i></button>
                        </div>
                    </form>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{route("single-category", $category->slug)}}" class="Goodup-catg-wrap">
                            <div class="Goodup-catg-city">{{$category->business_count}} Businesses</div>
                            <div class="Goodup-catg-icon"><img src="{!! url('images', [$category->path,$category->image,'80','80']) !!}" alt=""></div>
                            <div class="Goodup-catg-caption">
                                <h4 class="fs-md mb-0 ft-medium m-catrio">{{$category->name}}</h4>
                                <span class="text-muted">{{$category->product_count}} Products</span>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <section class="space min">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="sec_title position-relative text-center mb-5">
                        {{-- <h6 class="theme-cl mb-0">Featured Products</h6> --}}
                        <h2 class="ft-bold">Products </h2>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="{{route('single-product',$product->slug)}}" class="d-block text-center m-auto"><img src="{{$product->image}}" class="img-fluid" alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                @isset($product->price)
                                                <div class="Goodup-prt-price">$<span>{{$product->price}}</span></div>
                                                @endisset
                                            </div>
                                        </div>
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-cates multi mb-2">
                                                    <a href="{{route('single-category', $product->category->slug)}}" class="cats-1">{{$product->category->name}}</a>
                                                </div>
                                                <h4 class="mb-0 ft-medium medium">
                                                    <a href="{{route('single-product',$product->slug)}}" class="text-dark fs-md">{{$product->name}}</a>
                                                </h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    ...
                                                    {!! Controller::truncateString($product->description, 10, ' ...') !!}
                                                </div>
                                            </div>
                                            {{-- <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-7 col-md-9 col-sm-12">
                    <div class="sec_title position-relative text-center mb-5">
                        <h6 class="text-muted mb-2">Our Brands</h6>
                        <h2 class="ft-bold">We Have <span class="theme-cl">10,000+</span> Trusted Brands</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-3">
                        <img src="{{$brand->image}}" class="img-fluid mx-auto" style="height: 120px; " alt="{{$brand->name}}" />
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="content_block_2 pr-3 py-4">
                        <div class="content-box">
                            ...
                            <div class="btn-box clearfix mt-5">
                                <a href="index.html" class="download-btn play-store me-1 d-inline-flex"><img src="assets/img/ios.png" width="200" alt="" /></a>
                                <a href="index.html" class="download-btn play-store ms-2 mb-1 d-inline-flex"><img src="assets/img/and.png" width="200" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
